...
<main>
    ...
    <p>If the user fails 4 login attempts, they will have to wait 30 seconds until they can try to login again (resets 30 seconds for every attempt while they are locked out).</p>
</main>
<?php
